...
Com as vendas válidas isoladas, os indicadores de negócio pedidos no enunciado, ticket médio e produtos de maior faturamento, saem de duas agregações: uma por pedido (`invoice_no`) e outra por produto (`stock_code`).
...
print(f"Ticket medio: £ {orders['order_value'].mean():,.2f}")
print(f"Ticket mediano: £ {orders['order_value'].median():,.2f}")
