...
A assimetria positiva elevada indica uma cauda longa à direita e é compatível com a relação `moda < mediana < média`. O excesso de curtose positivo e elevado indica caudas mais pesadas que as da distribuição normal. Assim, valores muito distantes do centro, como os pedidos de atacado, ocorrem com frequência superior à esperada sob um modelo normal.

A curtose é menos evidente na inspeção direta dos dados porque descreve principalmente o peso das caudas, e não apenas a altura do pico. Costuma ser classificada em três tipos.

- **Leptocúrtica**. Apresenta excesso de curtose positivo e caudas mais pesadas que as da distribuição normal, com maior ocorrência de valores extremos.
- **Mesocúrtica**. Apresenta excesso de curtose próximo de zero, como a distribuição normal.
- **Platicúrtica**. Apresenta excesso de curtose negativo e caudas mais leves que as da distribuição normal, com menor ocorrência de valores extremos.
...
Da esquerda para a direita, os painéis mostram diferentes comportamentos das caudas. A distribuição uniforme possui limites fixos e não produz valores além deles. A distribuição normal apresenta caudas de peso moderado e constitui a referência para excesso de curtose igual a zero. A distribuição t de Student produz valores extremos com frequência muito maior. Este último comportamento se aproxima daquele indicado pela curtose elevada dos valores dos pedidos.
